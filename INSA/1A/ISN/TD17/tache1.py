...
LIEN_CALENDRIER = "https://insa-utils.fr/cal/get.php?url=https://ade-outils.insa-lyon.fr/ADE-Cal:~lpeyronnet!2024-2025:f96ff6e2442808995dadb7c8f88ebea2238501fc&mode=1&desc=true&count=true&types=general_sport,lang,sport,huma,support,p2i,other,*&ctypes=*,group,td,cm,tp,ev,soutien"
...
def obtenir_evenement_formate(evenement) -> str:
  ...
  """
    ...
    return f"- de {heure_debut} à {heure_fin} : {evenement.get('summary')}"
