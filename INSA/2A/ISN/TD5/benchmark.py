...
try:
    ...
    les_implementations.append(impl) # À commenter pour sortir cette implémentation du benchmark
    print("GaleShapleyV1.py : ok")
except ModuleNotFoundError:
    print("GaleShapleyV1.py : non sélectionné (Pas de fichier GaleShapleyV1.py dans le dossier)")
...
try:
    ...
    print("GaleShapleyV2.py : non sélectionné (Pas de fichier GaleShapleyV2.py dans le dossier)")
...
try:
    ...
    print("GaleShapleyV3.py : non sélectionné (Pas de fichier GaleShapleyV3.py dans le dossier)")
...
try:
    ...
    print("GaleShapleyV4.py : non sélectionné (Pas de fichier GaleShapleyV4.py dans le dossier)")
...
try:
    ...
    print("GaleShapleyV5.py : non sélectionné (Pas de fichier GaleShapleyV5.py dans le dossier)")
...
try:
    ...
    print("GaleShapleyV6.py : non sélectionné (Pas de fichier GaleShapleyV6.py dans le dossier)")
...
def appel_gale_shapley(fichier, implem) :
    ...
    paires = implem["module"].gale_shapley(etudiants, stages, prefs_etudiants, prefs_stages)
